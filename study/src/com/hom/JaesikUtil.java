...
//com.util에 있는 MyUtil을 나만의 스타일로 각색한것이다
   ...
   public String paging(int current_page, int total_page, String list_url) {
      ...
      while(page<=total_page && page<=(currentPageSetup+numPerBlock)) { // 25: (xx, 30)
    	  if(page==current_page) {
    		  sb.append("&nbsp;<span style='color:Fuchsia; font-size: '15';'>"+page+"</span>"); // 링크설정한거 아님 숫자만 보이게
    	  } else { 
      ...
      // [다음] [끝]
      n=currentPageSetup+1+numPerBlock; // 15들어오면: 25
      if(n>total_page)
    	  n=total_page;
