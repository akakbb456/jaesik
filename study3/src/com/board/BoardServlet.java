...
public class BoardServlet extends MyServlet{
	...
	protected void process(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//req.setCharacterEncoding("utf-8"); // 이제는 필터가 처리할거야
		...
		SessionInfo info = (SessionInfo)session.getAttribute("member"); // 이게 널이면 로그인이 안된거
		...
		if(uri.indexOf("list.do")!=-1) {
			...
			String articleUrl=cp+"/board/article.do?page="+current_page+"&rows="+numPerPage;
