...
public class MemberDAO {
	...
	public MemberDTO readMember(String userId) {
		...
		try {
			...
			sb.append("      LEFT OUTER JOIN member2 m2 "); // 쪼인했넹
	...
	public int insertMember(MemberDTO dto) { // 숙제
		int result=0;
		PreparedStatement pstmt=null;
		String sql;
		try {
	...
	public int updateMember(MemberDTO dto) { // 숙제
		int result=0;
		
		return result;
	}
	
	public int deleteMember(String userId) { // 숙제
		int result=0;
